...
//        ClassNode classNode1 = new ClassNode("Пустой класс");
            ...
            IndividualNode individualNode1 = new IndividualNode("Игорь", classNode2);

            IndividualNode individualNode2 = new IndividualNode("Коля", classNode2);
            individualNode2.addAttribute("Пол", "М");
            individualNode2.addAttribute("Возраст", "19");


            IndividualNode individualNode3 = new IndividualNode("Петя", classNode2);
            ...
            IndividualNode individualNode4 = new IndividualNode("Оля", classNode5);
            individualNode4.addAttribute("Возраст", "32");
            individualNode4.addAttribute("Отдел", "HR");

            IndividualNode individualNode5 = new IndividualNode("Варя", classNode5);
            IndividualNode individualNode6 = new IndividualNode("Василий", classNode3);
